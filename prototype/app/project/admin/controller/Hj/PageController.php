    ...
    public function indexAction()
    {
        ...
        if($PermissionCheck['return'])
        {
            ...
            foreach($pageList as $key => $pageInfo)
            {
                ...
                $pageList[$key]['page_url'] = $this->config->siteUrl.$this->config->api['list']['get_page']."/".$pageInfo['company_id']."/".$pageInfo['page_sign'];
                $pageList[$key]['test_url'] = $this->config->apiUrl.$this->config->api['list']['get_page']."/".$pageInfo['company_id']."/".$pageInfo['page_sign'];
