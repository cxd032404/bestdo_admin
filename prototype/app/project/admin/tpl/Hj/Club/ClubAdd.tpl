...
<tr class="hover">
<td>俱乐部名称</td>
	<td align="left"><input type="text" class="span2" name="club_name"  id="club_name" value="" size="50" /></td>
</tr>
<tr class="hover">
<td>俱乐部时间</td>
...
<th align="center" class="rowtip">
	...
	<td>俱乐部标识</td>
<td align="left"><input type="text" class="span4" name="club_sign"  id="club_sign" value="" size="50" /></td>
</tr>
