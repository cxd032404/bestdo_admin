...
{tpl:loop $companyList $companyInfo}
 ...
 |  <a href="javascript:;" onclick="companyModify('{tpl:$companyInfo.company_id/}');">修改</a>
  ...
  | <a target="_blank" href="{tpl:$companyInfo.reg_url/}">注册页面</a>
        | <a href="{tpl:$this.sign/}&ac=boutique&company_id={tpl:$companyInfo.company_id/}">精品课设置({tpl:$companyInfo.detail.boutique func='count(@@)'/}) </a> | <a href="{tpl:$this.sign/}&ac=step.banner&company_id={tpl:$companyInfo.company_id/}">健步走Banner({tpl:$companyInfo.detail.stepBanner func="count(@@)"/})</a></a>
      </td>
  </tr>
{/tpl:loop}
</table>
