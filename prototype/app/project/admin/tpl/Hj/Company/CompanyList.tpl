...
[ <a href="javascript:;" id="add_company"><img src="/icon/add.png" width='30' height='30'/></a> ]
</fieldset>
...
{tpl:loop $companyList $companyInfo}
  <tr class="hover">
    ...
    <td align="center">{tpl:$companyInfo.update_time/}</td>
      <td align="center"><a  href="javascript:;" onclick="companyDelete('{tpl:$companyInfo.company_id/}','{tpl:$companyInfo.parent_id/}','{tpl:$companyInfo.company_name/}')"><img src="/icon/del.png" width='30' height='30'/></a>
 |  <a href="javascript:;" onclick="companyModify('{tpl:$companyInfo.company_id/}');"><img src="/icon/edit2.png" width='30' height='30'/></a>
