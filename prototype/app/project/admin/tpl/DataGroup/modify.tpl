...
<INPUT TYPE="hidden" NAME="group_id" id="group_id" value="{tpl:$group.group_id/}">
	<tr>
		<th class="rowtip"><label for="group_id">数据权限组ID</label></th><td class="rowform">
		{tpl:$group.group_id/}</td>
	</tr>
	<tr>
		<th class="rowtip"><label for="name">数据权限组名</label></th><td class="rowform">
		<input type="text" name="name" id="name" class="span4" value="{tpl:$group.name/}"/>
		 <input name="ClassId" type="hidden" id="ClassId" value="2" /></td>
	</tr>
	<tr class="noborder">
		<th></th><td>
