...
<fieldset><legend>操作</legend>
	<div>
		<span style="float:right;"><a class="pb_btn_dark_1" href="javascript:;" id="add_group">新增</a></span>
	</div>
</fieldset>
...
<td>
	<a class = "pb_btn_light_1" href="javascript:;" onclick="groupModify('{tpl:$row.group_id/}')">修改</a>
	<a  class = "pb_btn_grey_1" href="javascript:;" onclick="promptDelete('{tpl:$row.group_id/}','{tpl:$row.name/}')">删除</a>
	 <a class = "pb_btn_light_1" href="?ctl=menu/permission&ac=modify.by.group&group_id={tpl:$row.group_id/}">菜单权限</a></td>
</tr>
{/tpl:loop}
</table>
</fieldset>
