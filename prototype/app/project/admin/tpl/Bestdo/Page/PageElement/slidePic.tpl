...
<tr class="hover"><td colspan="2">元素详情</td></tr>
	...
	<tr class="hover">
		...
		<td align="center"><a  href="javascript:;" onclick="pageElementDetailPop('{tpl:$pos/}')">删除</a>
	...
	var options = {
		...
		success:function(jsonResponse) {
			if (jsonResponse.errno) {
				...
				divBox.confirmBox({content:message,ok:function(){windowParent.getRightHtml('{tpl:$this.sign/}' + '&ac=page.element.detail&element_id=' + $('#element_id').val()s);}});
			}
		}
	};
